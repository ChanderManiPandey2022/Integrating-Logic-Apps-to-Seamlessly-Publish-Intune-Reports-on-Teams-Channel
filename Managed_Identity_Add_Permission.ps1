...
$Scopes = @(
  "DeviceManagementManagedDevices.Read.All", "AuditLog.Read.All", "User.Read.All","DeviceManagementApps.Read.All","DeviceManagementServiceConfig.Read.All","Device.Read.All","DeviceLocalCredential.Read.All","DeviceManagementConfiguration.Read.All"
)
